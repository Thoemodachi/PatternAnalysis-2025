...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--work-dir", type=Path, default=Path("artifacts"), help="Directory for prepared data")
    ...
    parser.add_argument("--project", type=str, default="runs/isic", help="Ultralytics project directory")
...
def validate_detector(
    ...
    detector = YOLODetector(model_path=model_path, device=device)
    detector.val(data=str(data_yaml), project=project, name=f"{name}_val", split="val")
